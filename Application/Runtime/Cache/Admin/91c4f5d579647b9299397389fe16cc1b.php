...
$(function(){  
	...
	$('#button').click(function(){
		...
		var url = "<?php echo U('Admin/active');?>" + '?date='+date;  
	...
	<div id="content-header">
    	<div id="breadcrumb"> <a href="#" title="返回首页" class="tip-bottom"><i class="icon-home"></i> 首页</a> <a href="#" class="current">活动管理</a> </div>
    	<h1>活动查看</h1>
  	</div>
  	<!-- 导航条结束-->
            			...
            			<thead>
              			...
              			<tbody>
               				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$va): $mod = ($i % 2 );++$i;?><tr>
								...
								<td><?php echo ($va["type_name"]); ?></td>
								<td><?php echo ($va["floor"]); ?></td>
