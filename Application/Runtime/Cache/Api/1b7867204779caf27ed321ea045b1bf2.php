...
<div class="wrap shop">
	...
	<!--认证方式 start-->
	<div class="hd_tip">&nbsp;&nbsp;对不起，服务器拒绝了您的请求</div>
	<!--认证方式 end-->
	<!--服务列表 start-->
	<div id="xj_pic">
		<img src="/mywifi/Public/img/api/error.jpg">
	</div>
	<!--服务列表 end-->
	<!--免费上网入口 start-->
	<div class="enter"><em>对不起，服务器拒绝了您的请求</em></div>
	<!--免费上网入口 end-->
		...
		<div style="text-align:center">WIFI认证失败,<span id="time" style="color: #F1560C">5</span>秒后自动跳转到认证首页</a></div>
